...
import { generateKeypair, generateKeypairFromSeed, sign } from 'mldsa65-wasm';
...
```ts
import { Signer, generateKeypair, generateKeypairFromSeed, sign, verify } from 'mldsa-wasm-rs/65';
// or
import { Signer, generateKeypair, generateKeypairFromSeed, sign, verify } from 'mldsa-wasm-rs/44';
import { Signer, generateKeypair, generateKeypairFromSeed, sign, verify } from 'mldsa-wasm-rs/87';
```

...
pub fn generate_keypair() -> KeyPair {
    mldsa_core::generate_keypair::<MlDsa44, VERIFYING_KEY_SIZE>()
}
...
pub fn sign(
    ...
    mldsa_core::sign::<MlDsa44, SIGNATURE_SIZE>(seed, message, context)
}
...
pub fn verify(
    ...
    mldsa_core::verify::<MlDsa44, VERIFYING_KEY_SIZE, SIGNATURE_SIZE>(vk, message, sig, context)
}
